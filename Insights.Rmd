...
preferences$time_submitted <- as.POSIXlt(parse_datetime(as.character(preferences$Timestamp), format = "%m/%d/%y %H:%M"))
...
Ratings <- tibble(pseudonym=preferences$pseudonym, artist_song=preferences$song_rated,Rating=preferences$rating)
view(Ratings)
